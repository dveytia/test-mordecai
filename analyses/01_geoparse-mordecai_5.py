...
# This differs from v4 because I try to limit working threads when initialising Geoparser()
# See "API and Configuration" https://github.com/openeventdata/mordecai

# Nevermind, threads = Fase doesnt work so try the batch_geoparse command
...
result = geo.batch_geoparse(df["text"])
